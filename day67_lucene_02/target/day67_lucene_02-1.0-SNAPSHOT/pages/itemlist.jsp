...
<div id="plist" class="m plist-n7 plist-n8 prebuy">
	<ul class="list-h">
		<c:forEach var="item" items="${result.itemList }">
		<li pid="${item.id }">
			<div class="lh-wrap">
				<div class="p-img">
					<a target="_blank" href="#">
						<img width="220" height="282" class="err-product" src="<c:url value='/images'/>/${item.pic}">
					</a>
				</div>
				<div class="p-name">
